...
import { createNewEvent_admin, createNewEvent_student, fetchEventDetails, getAllEvent_requests, getAllEvents_admin, getAllEvents_subAdmin, getAllRegisteredEvents, getEventAnalytics, registerForEvent, registrationStatusOfEvent, updateEvent } from '../controllers/eventControllers.js';
...
route.get("/registered-events",checkTokenAuthentication,getAllRegisteredEvents);
...
route.patch("/:eventId/update",checkTokenAuthentication,updateEvent);
